    ...
    <section>
        <div class="p-2">
            ...
            <div>
                ...
                <img src="{{ public_path('assets/images/kg_1.jpg') }}" class="pdf_image">
                @endif
                @if (@$student[0]['grade'] == 'kg 2') 
                <img src="{{ public_path('assets/images/kg_2.jpg') }}" class="pdf_image">
                @endif
                @if (@$student[0]['grade'] == 'pre kg') 
                <img src="{{ public_path('assets/images/pre_kg.jpg') }}" class="pdf_image">
                @endif
                @if (@$student[0]['grade'] == 'play home') 
                <img src="{{ public_path('assets/images/pdf_home.jpg') }}" class="pdf_image">
                @endif
                @if(@$student[0]['grade'] != 'kg 1' && @$student[0]['grade'] != 'kg 2' && @$student[0]['grade'] != 'play home' && @$student[0]['grade'] != 'pre kg')
                <img src="{{ public_path('assets/images/pdf_home.jpg') }}" class="pdf_image">
                @endif
            </div>
        </div>
