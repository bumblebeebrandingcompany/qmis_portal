...
<div class="container">
    ...
    <div class="card card-primary card-outline">
        <div class="card-body">
            {{-- Form --}}
            <form method="POST" action="{{ route("admin.stages.store") }}" enctype="multipart/form-data" class="my-custom-form">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <select name="selected_child_stages[]" id="selected_child_stages" class="form-control select2" multiple required data-minimum-results-for-search="Infinity">
