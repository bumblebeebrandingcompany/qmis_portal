...
$('.dataTables_info').html('Showing ' + (pageInfo.start + 1) + ' to ' + pageInfo.end + ' of ' + pageInfo.recordsTotal +
' entries');
}
};
...
$(document).on('change', '#project_id, #campaign_id, #source_id,#sub_source_id, #added_on, #leads_status, #no_lead_id,
#stage_id, #admission_team_name, #supervised_by', function () {
