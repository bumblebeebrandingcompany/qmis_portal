        ...
        @if (
            ...
            <div class="table-responsive">
                <table class="table table-bordered text-nowrap">
                    <tbody>
                        @if (is_array($lead->webhook_response) || is_object($lead->webhook_response))
                                            ...
                                            @if (
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered table-striped text-nowrap">
                                                        ...
                                                        <tbody>
                                                            <td>
                                                                <pre>{!! print_r($response['input'], true) !!}</pre>
                                                            </td>
                                                            <td>
                                                                <pre>{!! print_r($response['response'], true) !!}</pre>
                                                            </td>
                                                        </tbody>
                                                    </table>
                                                </div>
                        ...
                        @else
                            <tr>
                                <td colspan="2">{{$lead->webhook_response}}</td>
                            </tr>
                        @endif
                    </tbody>
                </table>
