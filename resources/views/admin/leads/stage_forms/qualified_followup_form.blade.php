<form id="QualifiedFollowupFormId" method="POST" action="{{ route('admin.followups.store') }}"
enctype="multipart/form-data">
@csrf
<div id="showqualifiedfollowup" class="myDiv">
    <!-- Your follow-up content goes here -->
    <div>
    </div>
    <div class="modal-body">
        <input type="hidden" name="lead_id" value="{{ $lead->id }}">
        <input type="hidden" name="parent_stage_id" value="31">
