...
<body>
    <div class="form-container">
        <div class="form-card">
            <form method="POST" action="{{ route('admin.updateLead', ['lead_id' => $lead->id]) }}">
                @csrf
                ...
                <div class="card p-2 mb-2">
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-group">
                            <label>Enter Father's WhatsApp number to get more details</label>

                            <div class="input-group">
                                <select name="father_country_code" class="form-control form-control-sm" required>
                                ...
                                <input type="tel" name="father_details[phone]" placeholder="Father's Phone" class="form-control form-control-sm" required>
                            </div>
                        </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input type="text" name="father_details[occupation]" placeholder="Occupation"
                            id="father_email" class="form-control form-control-sm" required>
                    </div>
                    <div class="form-group">
                ...
                <div class="card p-2 mb-2">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <select name="mother_country_code" class="form-control form-control-sm" required>
                                <option value="">Country Code</option>
                                <option value="+91">+91 (India)</option>
                                <option value="+1">+1 (USA)</option>
                                <option value="+44">+44 (UK)</option>
                            ...
                            <input type="tel" name="mother_details[phone]" placeholder="WhatsApp number" class="form-control form-control-sm" required>
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <div class="card p-2 mb-2">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <select name="guardian_country_code" class="form-control form-control-sm" >
                                <option value="">Country Code</option>
                                <option value="+91">+91 (India)</option>
                                <option value="+1">+1 (USA)</option>
                                <option value="+44">+44 (UK)</option>
                            ...
                            <input type="tel" name="guardian_details[phone]" placeholder="WhatsApp number" class="form-control form-control-sm" >
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input type="test" name="guardian_details[income]" placeholder="income"
                    ...
                    <div class="card p-2 mb-2 child-details">
                        ...
                        <div class="form-group">
                            <select name="student_details[0][grade]" class="form-control grade-select">
                                ...
                                <option value="pre kg">Play Home</option>
                ...
                <div class="form-group">
                    <select class="form-control form-control-lg" name="source_name" id="source_id" required onchange="handleSourceChange()">
                        <option value="" selected disabled>Source</option>
                        <option value="Parent referral">Parent referral</option>
                        <option value="Teacher referral">Teacher referral</option>
                ...
                <div class="form-group">
                    <input type="text" name="sub_source_name" placeholder="Sub Source"
                        class="form-control form-control-lg" id="sub_source_name" required>
                </div>
                ...
                <!-- Comments -->
                <div class="form-group">
                    <textarea name="comments" class="form-control form-control-lg" id="comments" rows="2" placeholder="Comments"></textarea>
                </div>
...
<script>
    function toggleSubSourceField() {
        var selectedSource = document.getElementById("sub_source_id").value;
        var subSourceField = document.getElementById("sub_source_field");

        if (selectedSource === "Website" || selectedSource === "Google" || selectedSource === "Meta") {
            subSourceField.style.display = "none";  // Hide the sub source field
            document.getElementById("sub_source_name").required = false; // Make sub-source not required
        } else {
            subSourceField.style.display = "block";  // Show the sub source field
            document.getElementById("sub_source_name").required = true; // Make sub-source required
        }
    }
</script>
<script>
    function handleSourceChange() {
        ...
        const subSourceInput = document.getElementById('sub_source_name');
        const selectedSource = sourceSelect.value;

        // List of sources that should auto-fill the sub-source field
        const autoFillSources = ['Website', 'Google', 'Meta'];

        if (autoFillSources.includes(selectedSource)) {
            subSourceInput.value = selectedSource; // Automatically fill the sub-source
            subSourceInput.readOnly = true; // Make the field read-only
        } else {
            subSourceInput.value = ''; // Clear the field
            subSourceInput.readOnly = false; // Allow manual input
        }
    }
</script>