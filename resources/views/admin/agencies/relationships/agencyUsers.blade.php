    ...
    <div class="card card-primary card-outline">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-agencyUsers">
                    <thead>
                        <tr>
                            <th width="10">
...
@endif
  ...
  let table = $('.datatable-agencyUsers:not(.ajaxTable)').DataTable({ buttons: dtButtons })
