    ...
    <div class="screen-1">
        <div class="scrollable-container">
            <div class="rectangle-1">
                <div style="width:100%"><img style="width:100%" src="{{ asset('assets/images/qmis_learning.svg') }}"></div>
                <div class="bottom-container">
                    <a class="schedule-button" style="font-weight: bold;text-align:center"
                        href="{{ route('client.oneStep', ['id' => $lead]) }}">PROCEED TO APPLY</a>
                </div>
            </div>
        </div>
    </div>
...
<style>
    ...
    .rectangle-1 {
        /* background: url('{{ asset('assets/images/qmis_learning.svg') }}'); */
