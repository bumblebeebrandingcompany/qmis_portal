    ...
    <div class="screen-6">
        ...
        <div class="content">
            ...
            <div class="features">
                ...
                <div class="feature-item" style="text-align: left">
                    <img class="check-icon" src="{{ asset('assets/vectors/subtract_10_x2.svg') }}" />
                    <span>A comprehensive scorecard that gives you insights into your child’s personality and
                        skillset.</span>
                </div>
                <div class="feature-item" style="text-align: left">
                    <img class="check-icon" src="{{ asset('assets/vectors/subtract_10_x2.svg') }}" />
            ...
            <a class="pay-now" href="{{ route('client.siteVisit.createpayment', ['id' => $lead->id,'sv_id'=>$siteVisit->id ,'amount' => '999']) }}">Pay
                NOW</a>
        </div>
        ...
        <div class="popup-overlay" id="popupOverlay">
            <div class="popup-content">
                ...
                <a class="start-button" href="{{ route('client.schemeDetails', ['id' => $lead->id]) }}">Let's
                    Start</a>
            </div>
        </div>
    </div>
...
@section('scripts')
    ...
    <script>
        function makePayment(id) {
            fetch(`/client/site-visit/payment/${id}/${sv_id}`, {
                    method: 'POST',
                    headers: {
                ...
                .then(order => {
                    var options = {
                        ...
                        "handler": function(response) {
                            ...
                            form.method = 'POST';
                            form.action = `/payment/complete/${id}/${sv_id}`;
